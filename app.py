...
div[data-testid="stVerticalBlockBorderWrapper"]:has(#floating-visual-qa-marker),div[data-testid="stLayoutWrapper"]:has(#floating-visual-qa-marker){position:fixed!important;right:1.25rem;bottom:1.25rem;z-index:999999;width:auto!important;max-width:calc(100vw - 2rem);margin:0!important;filter:drop-shadow(0 8px 22px rgba(8,47,73,.22))}
...
div[data-testid="stVerticalBlockBorderWrapper"]:has(#floating-visual-qa-marker) button,div[data-testid="stLayoutWrapper"]:has(#floating-visual-qa-marker) button{border-radius:999px!important;background:#0f766e!important;color:#fff!important;border:1px solid #5eead4!important;font-weight:800!important;min-height:46px!important}
div[data-testid="stVerticalBlockBorderWrapper"]:has(#floating-visual-qa-marker) button:hover,div[data-testid="stLayoutWrapper"]:has(#floating-visual-qa-marker) button:hover{background:#07594f!important;border-color:#99f6e4!important}
...
@media(max-width:640px){div[data-testid="stVerticalBlockBorderWrapper"]:has(#floating-visual-qa-marker),div[data-testid="stLayoutWrapper"]:has(#floating-visual-qa-marker){right:.65rem;bottom:.75rem;max-width:calc(100vw - 1.3rem)}}
</style>
"""
